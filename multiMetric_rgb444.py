...
# path_org ="/media/lab/kangwenbo/Sketch-to-Face/Codes/org.jpg"
# path_rec ="/media/lab/kangwenbo/Sketch-to-Face/Codes/rec.jpg"
if __name__ == "__main__":
       
    width=128
    height=128
    
    # seqlist=['001' ,'002','003','004','005','006','007','008','009','010','011','012','013','014','015','016','017','018']
    ...
    Iframe_format='RGB444'   ## 'YUV420'  OR 'RGB444'
    ...
    result_dir = '/media/media/6dbfb7d7-4857-4183-acea-f582f662b061/liulu/trainVVC/testall/testVVCbin/experiment/'
    seqIdx=0
    for seq in seqlist:
        qpIdx=0
        for qp in qplist:
            ...
            # f_org=open('./testing_sequence/'+testingdata_name+'_'+str(seq)+'_'+str(width)+'x'+str(height)+'_25_8bit_444.rgb','rb')
            ...
            for frame in range(0,frames):
                frame1 = f"{frame:04d}"
                # f_org='/media/media/6dbfb7d7-4857-4183-acea-f582f662b061/liulu/trainVVC/testVVC/'+testingdata_name+'/'+testingdata_name+ str(seq)+'/QP'+"22"+'/gt/'+ str(frame1) +'_gt_img_3.png'
                # f_org = '/media/media/6dbfb7d7-4857-4183-acea-f582f662b061/liulu/trainVVC/testVVC/voxcelebgt/voxeleb'+ str(seq) + '/gt/' + str(frame1) + '_gt_img_3.png'
                f_org = '/media/media/6dbfb7d7-4857-4183-acea-f582f662b061/liulu/gfvc_v1-AhG16_GFVC_Software_v4/source/experiment/Ori_frames/'+testingdata_name+'_' + str(seq) + '_0/' + str(frame1) +'.png'

                f_test='/media/media/6dbfb7d7-4857-4183-acea-f582f662b061/liulu/gfvc_v1-AhG16_GFVC_Software_v4/source/experiment/Rec_frames/'+testingdata_name+'_'+ str(seq)+'_'+qp+'/' + str(frame1) +'.png'
                img_org = Image.open(f_org).convert("RGB")
                img_test = Image.open(f_test).convert("RGB")

                img_org = img_org.resize((height, width), Image.BILINEAR)
                img_test = img_test.resize((height, width), Image.BILINEAR)


                img_org = np.array(img_org).transpose((2,0,1))
                img_test = np.array(img_test).transpose((2, 0, 1))
